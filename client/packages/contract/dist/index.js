...
export class Client extends ContractClient {
    ...
    constructor(options) {
        super(new ContractSpec(["AAAAAQAAAAAAAAAAAAAABlJlc3VtZQAAAAAABAAAAAAAAAAKZXhwZXJpZW5jZQAAAAAAEAAAAAAAAAAEbmFtZQAAABAAAAAAAAAACXBvcnRmb2xpbwAAAAAAABAAAAAAAAAABnNraWxscwAAAAAAEA==",
            ...
            "AAAAAAAAAAAAAAAKZ2V0X3Jlc3VtZQAAAAAAAQAAAAAAAAACaWQAAAAAAAYAAAABAAAD6AAAB9AAAAAGUmVzdW1lAAA="]), options);
